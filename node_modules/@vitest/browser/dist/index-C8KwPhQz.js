import{server as e,page as t,utils as n}from"vitest/browser";import{__INTERNAL as r,getSafeTimers as i}from"vitest/internal/browser";function a(e){"@babel/helpers - typeof";return a=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},a(e)}function o(e,t){if(a(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t);if(a(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}function s(e){var t=o(e,`string`);return a(t)==`symbol`?t:t+``}function c(e,t,n){return(t=s(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const l=function(e,t,n){return e>=t&&e<=n};function u(e){return l(e,48,57)}function d(e){return u(e)||l(e,65,70)||l(e,97,102)}function f(e){return l(e,65,90)}function p(e){return l(e,97,122)}function m(e){return f(e)||p(e)}function h(e){return e>=128}function g(e){return m(e)||h(e)||e===95}function ee(e){return g(e)||u(e)||e===45}function te(e){return l(e,0,8)||e===11||l(e,14,31)||e===127}function _(e){return e===10}function v(e){return _(e)||e===9||e===32}var y=class extends Error{constructor(e){super(e),this.name=`InvalidCharacterError`}};function ne(e){let t=[];for(let n=0;n<e.length;n++){let r=e.charCodeAt(n);if(r===13&&e.charCodeAt(n+1)===10&&(r=10,n++),(r===13||r===12)&&(r=10),r===0&&(r=65533),l(r,55296,56319)&&l(e.charCodeAt(n+1),56320,57343)){let t=r-55296,i=e.charCodeAt(n+1)-56320;r=2**16+t*2**10+i,n++}t.push(r)}return t}function b(e){if(e<=65535)return String.fromCharCode(e);e-=2**16;let t=Math.floor(e/2**10)+55296,n=e%2**10+56320;return String.fromCharCode(t)+String.fromCharCode(n)}function re(e){let t=ne(e),n=-1,r=[],i,a=function(e){return e>=t.length?-1:t[e]},o=function(e){if(e===void 0&&(e=1),e>3)throw`Spec Error: no more than three codepoints of lookahead.`;return a(n+e)},s=function(e){return e===void 0&&(e=1),n+=e,i=a(n),!0},c=function(){return--n,!0},l=function(e){return e===void 0&&(e=i),e===-1},f=function(){if(p(),s(),v(i)){for(;v(o());)s();return new oe}else if(i===34)return y();else if(i===35)if(ee(o())||S(o(1),o(2))){let e=new Oe(``);return T(o(1),o(2),o(3))&&(e.type=`id`),e.value=D(),e}else return new C(i);else if(i===36)return o()===61?(s(),new xe):new C(i);else if(i===39)return y();else if(i===40)return new ge;else if(i===41)return new _e;else if(i===42)return o()===61?(s(),new Se):new C(i);else if(i===43)return E()?(c(),m()):new C(i);else if(i===44)return new de;else if(i===45)return E()?(c(),m()):o(1)===45&&o(2)===62?(s(2),new ce):Pe()?(c(),h()):new C(i);else if(i===46)return E()?(c(),m()):new C(i);else if(i===58)return new le;else if(i===59)return new ue;else if(i===60)return o(1)===33&&o(2)===45&&o(3)===45?(s(3),new se):new C(i);else if(i===64)return T(o(1),o(2),o(3))?new De(D()):new C(i);else if(i===91)return new me;else if(i===92)return w()?(c(),h()):new C(i);else if(i===93)return new he;else if(i===94)return o()===61?(s(),new be):new C(i);else if(i===123)return new fe;else if(i===124)return o()===61?(s(),new ye):o()===124?(s(),new Ce):new C(i);else if(i===125)return new pe;else if(i===126)return o()===61?(s(),new ve):new C(i);else if(u(i))return c(),m();else if(g(i))return c(),h();else if(l())return new we;else return new C(i)},p=function(){for(;o(1)===47&&o(2)===42;)for(s(2);;)if(s(),i===42&&o()===47){s();break}else if(l())return},m=function(){let e=Ie();if(T(o(1),o(2),o(3))){let t=new Ne;return t.value=e.value,t.repr=e.repr,t.type=e.type,t.unit=D(),t}else if(o()===37){s();let t=new Me;return t.value=e.value,t.repr=e.repr,t}else{let t=new je;return t.value=e.value,t.repr=e.repr,t.type=e.type,t}},h=function(){let e=D();if(e.toLowerCase()===`url`&&o()===40){for(s();v(o(1))&&v(o(2));)s();return o()===34||o()===39||v(o())&&(o(2)===34||o(2)===39)?new Ee(e):re()}else if(o()===40)return s(),new Ee(e);else return new Te(e)},y=function(e){e===void 0&&(e=i);let t=``;for(;s();)if(i===e||l())return new ke(t);else if(_(i))return c(),new ie;else i===92?l(o())||(_(o())?s():t+=b(x())):t+=b(i);throw Error(`Internal error`)},re=function(){let e=new Ae(``);for(;v(o());)s();if(l(o()))return e;for(;s();)if(i===41||l())return e;else if(v(i)){for(;v(o());)s();return o()===41||l(o())?(s(),e):(O(),new ae)}else if(i===34||i===39||i===40||te(i))return O(),new ae;else if(i===92)if(w())e.value+=b(x());else return O(),new ae;else e.value+=b(i);throw Error(`Internal error`)},x=function(){if(s(),d(i)){let e=[i];for(let t=0;t<5&&d(o());t++)s(),e.push(i);v(o())&&s();let t=Number.parseInt(e.map(e=>String.fromCharCode(e)).join(``),16);return t>1114111&&(t=65533),t}else if(l())return 65533;else return i},S=function(e,t){return!(e!==92||_(t))},w=function(){return S(i,o())},T=function(e,t,n){return e===45?g(t)||t===45||S(t,n):g(e)?!0:e===92?S(e,t):!1},Pe=function(){return T(i,o(1),o(2))},Fe=function(e,t,n){return e===43||e===45?!!(u(t)||t===46&&u(n)):e===46?!!u(t):!!u(e)},E=function(){return Fe(i,o(1),o(2))},D=function(){let e=``;for(;s();)if(ee(i))e+=b(i);else if(w())e+=b(x());else return c(),e;throw Error(`Internal parse error`)},Ie=function(){let e=``,t=`integer`;for((o()===43||o()===45)&&(s(),e+=b(i));u(o());)s(),e+=b(i);if(o(1)===46&&u(o(2)))for(s(),e+=b(i),s(),e+=b(i),t=`number`;u(o());)s(),e+=b(i);let n=o(1),r=o(2),a=o(3);if((n===69||n===101)&&u(r))for(s(),e+=b(i),s(),e+=b(i),t=`number`;u(o());)s(),e+=b(i);else if((n===69||n===101)&&(r===43||r===45)&&u(a))for(s(),e+=b(i),s(),e+=b(i),s(),e+=b(i),t=`number`;u(o());)s(),e+=b(i);let c=Le(e);return{type:t,value:c,repr:e}},Le=function(e){return+e},O=function(){for(;s();)if(i===41||l())return;else w()&&x()},k=0;for(;!l(o());)if(r.push(f()),k++,k>t.length*2)throw Error(`I'm infinite-looping!`);return r}var x=class{constructor(){c(this,`tokenType`,``),c(this,`value`,void 0)}toJSON(){return{token:this.tokenType}}toString(){return this.tokenType}toSource(){return`${this}`}},ie=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`BADSTRING`)}},ae=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`BADURL`)}},oe=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`WHITESPACE`)}toString(){return`WS`}toSource(){return` `}},se=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`CDO`)}toSource(){return`<!--`}},ce=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`CDC`)}toSource(){return`-->`}},le=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`:`)}},ue=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`;`)}},de=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`,`)}},S=class extends x{constructor(...e){super(...e),c(this,`value`,``),c(this,`mirror`,``)}},fe=class extends S{constructor(){super(),c(this,`tokenType`,`{`),this.value=`{`,this.mirror=`}`}},pe=class extends S{constructor(){super(),c(this,`tokenType`,`}`),this.value=`}`,this.mirror=`{`}},me=class extends S{constructor(){super(),c(this,`tokenType`,`[`),this.value=`[`,this.mirror=`]`}},he=class extends S{constructor(){super(),c(this,`tokenType`,`]`),this.value=`]`,this.mirror=`[`}},ge=class extends S{constructor(){super(),c(this,`tokenType`,`(`),this.value=`(`,this.mirror=`)`}},_e=class extends S{constructor(){super(),c(this,`tokenType`,`)`),this.value=`)`,this.mirror=`(`}},ve=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`~=`)}},ye=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`|=`)}},be=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`^=`)}},xe=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`$=`)}},Se=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`*=`)}},Ce=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`||`)}},we=class extends x{constructor(...e){super(...e),c(this,`tokenType`,`EOF`)}toSource(){return``}},C=class extends x{constructor(e){super(),c(this,`tokenType`,`DELIM`),c(this,`value`,``),this.value=b(e)}toString(){return`DELIM(${this.value})`}toJSON(){let e=this.constructor.prototype.constructor.prototype.toJSON.call(this);return e.value=this.value,e}toSource(){return this.value===`\\`?`\\
